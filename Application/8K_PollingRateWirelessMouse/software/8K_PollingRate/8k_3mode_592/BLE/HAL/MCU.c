 ...
 * @return  None.
 */
void CH59X_BLEInit(uint32_t snv_addr)
{
    uint8_t     i;
    bleConfig_t cfg;
...
//            tmos_start_task(halTaskID, HAL_REG_INIT_EVENT, 3);
...
//        {
//            if( ((access_state.work_mode == WORK_MODE_2_4G) && (nvs_flash_info.enable_2_4G_sleep))
//                || ((access_state.work_mode > WORK_MODE_2_4G) && (access_state.work_mode < WORK_MODE_MAX)
//                    && (nvs_flash_info.enable_ble_sleep)) )
//            {
//                access_update_idel_sleep_timeout(DISCONNECT_WAIT_REPORT_END_TIMEOUT);
//            }
//        }
