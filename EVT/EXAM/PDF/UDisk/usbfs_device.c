 ...
 *
 * @param   endp - Endpoint number to send
 *          pbuf - Pointer to the data buffer to be sent
 *          len - The length of data to be sent
 *          mod - The mode of sending data can be DEF_UEP_DMA_Load (DMA mode) or DEF_UEP_COPY (copy mode).
 *
 * @return  0 -  transmission is successful
 *          1 - the specified endpoint is already occupied
 */
